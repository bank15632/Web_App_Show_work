...
export default async function ProjectRoomPage({ params }: ProjectPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        {/* Hero — title + hero image placeholder */}
        <section className="border-b border-border">
          <div className="mx-auto max-w-7xl px-5 pb-12 pt-8 md:px-8 md:pb-16 md:pt-10 xl:px-12 xl:pb-20">
            ...
            <div className="mt-10 flex aspect-[16/9] items-center justify-center overflow-hidden rounded-2xl bg-secondary">
              <p className="text-sm text-muted-foreground">
                Hero image — รูปหลักของโปรเจกต์
              </p>
            </div>

            {/* About + metadata — simple 2-column layout */}
