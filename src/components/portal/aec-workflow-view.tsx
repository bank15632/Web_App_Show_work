  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#f7f3ed_100%)]">
      <header className="sticky top-0 z-20 border-b border-border bg-background/95 backdrop-blur-[10px]">
        <div className="mx-auto flex max-w-[1600px] flex-wrap items-center gap-3 px-6 py-5 lg:px-10">
          <Link
            href="/"
      ...
      <main className="mx-auto max-w-[1600px] space-y-14 px-6 py-12 lg:px-10">
